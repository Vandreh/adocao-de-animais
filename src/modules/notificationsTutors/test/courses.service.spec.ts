...
describe('CoursesService', () => {
  ...
  it('Create: should creates a course', async () => {
  ...
  it('findAll: should list courses', async () => {
    const expectOutputTags = [
      {
        id,
        name: 'Tag test',
  ...
  it('findOne: should gets a course', async () => {
    const expectOutputTags = [
      {
        id,
        name: 'Tag test',
  ...
  it('findOne: should NOT gets a course', async () => {
    const expectOutputTags = [
        {
          id,
          name: 'Tag test',
  ...
  it('Update: should updates a course', async () => {
    const expectOutputTags = [
      {
        id,
        name: 'Tag test',
  ...
  it('Delete: should deletes a course', async () => {
    const expectOutputTags = [
      {
        id,
        name: 'Tag test',
